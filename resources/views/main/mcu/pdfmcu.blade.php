                        ...
                        "columns": [
                            ...
                            },  
                            {
                                "render": function (data, type, row) {
                                    ...
                                    var html = ' <div class="dropdown"><button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-bars"></i><span class="caret"></span></button><ul class="dropdown-menu"><li><a href="#" onclick=\'gohasillab("' +  row.NoRegistrasi + '")\'><i class="fa fa-file" aria-hidden="true"></i> Hasil Laboratorium</a></li><li><a href="#"  onclick=\'gohasilrad("' +  row.NoRegistrasi + '")\'><i class="fa fa-file-text-o" aria-hidden="true"></i> Hasil Radiologi</a></li><li><a href="#" onclick=\'gohasilmcu("' +  row.NoRegistrasi + '")\'><i class="fa fa-file-text" aria-hidden="true"></i> Hasil MCU</a></li><li><a href="#" onclick=\'goGenerate("' +  row.NoRegistrasi + '")\'><i class="fa fa-folder-o" aria-hidden="true"></i> Generate Hasil</a></li></ul> </div>'
                                    return html
                                }
                            },
                        ]
